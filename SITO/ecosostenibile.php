  ...
  <div class="collapse navbar-collapse">
   ...
   <!-- main-banner -->
    <div class="main-banner">
        <div class="container">
             <img src="img/blog/eco-legno.jpg" class="img-responsive" id="img">
        </div>
    </div>
    ...
    <div class="post-widgets">
        <div class="container">
            <div class="row">
				...
				$query_articoli="SELECT * FROM articoli WHERE categoria = 'architettura ecosostenibile'";
